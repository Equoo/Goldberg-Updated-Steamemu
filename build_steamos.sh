...
g++ -m32 -shared -fPIC -fvisibility=hidden -Wl,--exclude-libs,ALL -DGNUC -DEMU_RELEASE_BUILD -DEMU_EXPERIMENTAL_BUILD -DNDEBUG -DCONTROLLER_SUPPORT -DEMU_OVERLAY -s -o linux/experimental/x86/libsteam_api.so dll/*.cpp dll/*.cc controller/*.c detours/*.cpp ImGui/*.cpp ImGui/backends/imgui_impl_dx*.cpp ImGui/backends/imgui_impl_win32.cpp ImGui/backends/imgui_impl_vulkan.cpp ImGui/backends/imgui_impl_opengl3.cpp ImGui/backends/imgui_win_shader_blobs.cpp overlay_experimental/*.cpp overlay_experimental/linux/*.cpp overlay_experimental/System/*.cpp -Wno-return-type -IImGui -Ioverlay_experimental -I../protobuf/prefix_x86/include/ -L../protobuf/prefix_x86/lib/ -lGL -lprotobuf-lite -lpthread -ldl -std=c++14 && echo built32
...
g++ -shared -fPIC -fvisibility=hidden -Wl,--exclude-libs,ALL -DGNUC -DEMU_RELEASE_BUILD -DEMU_EXPERIMENTAL_BUILD -DNDEBUG -DCONTROLLER_SUPPORT -DEMU_OVERLAY -s -o linux/experimental/x86_64/libsteam_api.so dll/*.cpp dll/*.cc controller/*.c  detours/*.cpp ImGui/*.cpp ImGui/backends/imgui_impl_dx*.cpp ImGui/backends/imgui_impl_win32.cpp ImGui/backends/imgui_impl_vulkan.cpp ImGui/backends/imgui_impl_opengl3.cpp ImGui/backends/imgui_win_shader_blobs.cpp overlay_experimental/*.cpp overlay_experimental/linux/*.cpp overlay_experimental/System/*.cpp -Wno-return-type -IImGui -Ioverlay_experimental -I../protobuf/prefix/include/ -L../protobuf/prefix/lib/ -lGL -lprotobuf-lite -lpthread -ldl -std=c++14 && echo built64
