...
g++ -m32 -shared -fPIC -fvisibility=hidden -Wl,--exclude-libs,ALL -DGNUC -DEMU_RELEASE_BUILD -DEMU_EXPERIMENTAL_BUILD -DNDEBUG -DCONTROLLER_SUPPORT -DEMU_OVERLAY -s -o linux/experimental/x86/libsteam_api.so dll/*.cpp dll/*.cc controller/*.c -Wno-return-type -Ioverlay_experimental -I../protobuf/prefix_x86/include/ -L../protobuf/prefix_x86/lib/ -lprotobuf-lite -lpthread -ldl -std=c++14 && echo built32
...
g++ -shared -fPIC -fvisibility=hidden -Wl,--exclude-libs,ALL -DGNUC -DEMU_RELEASE_BUILD -DEMU_EXPERIMENTAL_BUILD -DNDEBUG -DCONTROLLER_SUPPORT -DEMU_OVERLAY -s -o linux/experimental/x86_64/libsteam_api.so dll/*.cpp dll/*.cc controller/*.c -Wno-return-type -Ioverlay_experimental -I../protobuf/prefix/include/ -L../protobuf/prefix/lib/ -lprotobuf-lite -lpthread -ldl -std=c++14 && echo built64
